...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "CXTestUtility", dependencies: ["CXUtility", "_CXShim", "_CXTest", "Semver", "Quick", "Nimble"]),
        .testTarget(name: "CombineXTests", dependencies: ["CXTestUtility", "CXUtility", "Quick", "Nimble"]),
...
let shimTarget = package.targets.first(where: { $0.name == "_CXShim" })!
