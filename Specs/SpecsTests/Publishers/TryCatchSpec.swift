    ...
    override func spec() {
        ...
        describe("Send Values") {
            ...
            it("should use new publisher if upstream ends with error") {
                let p0 = Publishers.Fail<Int, CustomError>(error: .e0)
            ...
            it("should send as many value as demand") {
                let p0 = Publishers.Sequence<[Int], CustomError>(sequence: [1, 2, 3, 4, 5]).append(Publishers.Fail<Int, CustomError>(error: .e0))
            ...
            it("should fail if error handle throws an error") {
                typealias Pub0 = Publishers.Fail<Int, CustomError>
